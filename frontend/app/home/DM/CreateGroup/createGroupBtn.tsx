...
const createGroupBtn = () => {
  ...
  return (
    <main className={styles.createGroupBtnContainer}>
      {isCreateGroupVisible && <CreateGroup onClose={hideCreateGroup} />}
      <button
        className={styles.CreateGroupBtn}
        onClick={showCreateGroup}
        onMouseEnter={() => setHoveredButton("Create Group")}
      ...
      >
        ...
        >
          ...
          <g transform="scale(0.7) translate(8, 8)">
            ...
            />
            <path
              transform="scale(1.1) translate(1, 4)"
              fill="var(--container-color)"
              d="M10 5v4H6v2h4v4h2v-4h4V9h-4V5h-2z"
            />
          </g>
        </svg>
